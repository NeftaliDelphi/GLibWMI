...
type
  ...
  public
    ...
    // Obtener el número de elementos disponibles de la propiedad <Access>
  ...
  published
    ...
    ///  (0) y "De sólo una escritura" (4) también se pueden definir.
    /// </summary>
    ...
    /// <summary>
    ///  Tamaño en bytes de los bloques que forman este StorageExtent. Si el tamaño del bloque es variable, entonces 
    ///  se debe especificar el tamaño de bloque máximo en bytes. Si el tamaño de bloque es desconocido o un concepto 
    ///  de bIoque no es válido (por ejemplo, para Aggregate Extents, Memory o LogicalDisks), escriba un 1.
    /// </summary>
    property BlockSize:int64 read FBlockSize write FBlockSize stored False;
    /// <summary>
    ///  El valor booleano indica que DiskPartition está etiquetada como de arranque. No significa que un OperatingSystem 
    ///  esté instalado en la participación.
    /// </summary>
    property Bootable:boolean read FBootable write FBootable stored False;
    /// <summary>
    ///  La propiedad BootPartition determina si ésta es la partición activa. El sistema operativo usa la partición 
    ///  activa al arrancar desde un disco duro.
    ///  Valores: TRUE o FALSE. Si es TRUE, la partición es la activa
    ///  .
    /// </summary>
    ...
    /// <summary>
    ///  La propiedad DeviceID contiene una cadena que identifica de forma única la unidad de disco y la partición 
    ///  del resto del sistema.
    /// </summary>
    property DeviceID:string read FDeviceID write FDeviceID stored False;
    /// <summary>
    ///  La propiedad DiskIndex indica el número de índice del disco que contiene esta partición.
    ///  Ejemplo: 0.
    /// </summary>
    ...
    /// <summary>
    ///  ErrorMethodology es una cadena de forma libre que describe el tipo de detección o corrección de errores 
    ///  admitido por esta extensión de almacenamiento.
    /// </summary>
    property ErrorMethodology:string read FErrorMethodology write FErrorMethodology stored False;
    /// <summary>
    ///  La propiedad HiddenSectors indica el número de sectores ocultos de la partición.
    ///  Ejemplo: 63
    /// </summary>
    ...
    /// <summary>
    ///  Número total de bloques consecutivos, cada  uno bloquea el tamaño del valor contenido en la propiedad 
    ///  BlockSize que forma esta extensión de almacenamiento. Tamaño total de la extensión  de almacenamiento 
    ///  puede ser calculado multiplicando el valor de la propiedad BlockSize por el valor de esta propiedad. 
    ///  Si el valor de BlockSize es 1, esta propiedad es el tamaño total de la extensión de almacenamiento.
    /// </summary>
    ...
    /// <summary>
    ///  Booleano indicando que DiskPartition está etiquetada como la partición primaria para un ComputerSyst
    ///  em.
    /// </summary>
    ...
    /// <summary>
    ///  La propiedad RewritePartition especifica si la información de la partición ha cambiado. Cuando cambia 
    ///  una partición (con IOCTL_DISK_SET_DRIVE_LAYOUT), el sistema usa este miembro de la propiedad para determinar 
    ///  qué particiones han cambiado y es necesario volver a escribir su información.
    ///  Valores: TRUE o FALSE. 
    ///  Si es TRUE, es necesario volver a escribir la partición.
    /// </summary>
    property RewritePartition:boolean read FRewritePartition write FRewritePartition stored False;
    /// <summary>
    ///  La propiedad Size indica el tamaño total (en bytes) de la partición.
    ///  Ejemplo: 1059045376
    /// </summary>
    property Size:int64 read FSize write FSize stored False;
    /// <summary>
    ///  La propiedad StartingOffset indica la posición de inicio (en bytes) de la partición.
    ///  Ejemplo: 32256
    /// </summary>
...
const 
  ...
  ENUM_STRING_ACCESS_04 = 'De sólo una escritura';
...
const 
  ...
  ENUM_STRING_TYPE__05 = 'Partición extendida';
  ...
  ENUM_STRING_TYPE__13 = 'Administrador de discos lógicos';
