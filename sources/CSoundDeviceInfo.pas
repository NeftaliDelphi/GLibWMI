{
TSoundDeviceInfo Component Version 3.0 - Suite GLibWMI
...
type
  ...
  published
    ...
    /// <summary>
    ///  La propiedad DeviceID contiene información que identifica de forma única el dispositivo de sonido.
    /// </summary>
    property DeviceID:string read FDeviceID write FDeviceID stored False;
    /// <summary>
    ///  La propiedad DMABufferSize indica el tamaño del búfer de acceso directo a memoria.
    ///  Ejemplo: 4
    /// </summary>
    ...
    /// <summary>
    ///  La propiedad Manufacturer indica el fabricante del dispositivo de sonido.
    ///  Ejemplo: Creative Labs
    /// </summary>
    property Manufacturer:string read FManufacturer write FManufacturer stored False;
    /// <summary>
    ///  La propiedad MPU401Address indica la dirección de E/S inicial asignada al puerto MPU-401 del dispositivo 
    ///  de sonido.
    ///  Ejemplo: 300
    /// </summary>
    property MPU401Address:integer read FMPU401Address write FMPU401Address stored False;
    /// <summary>
    ///  La propiedad MPU401Address indica la dirección de E/S inicial asignada al puerto MPU-401 del dispositivo 
    ///  de sonido.
    ///  Ejemplo: 300
    ...
    /// <summary>
    ///  La propiedad ProductName indica el nombre de producto del dispositivo de sonido.
    ///  Ejemplo: Creative Labs 
    ///  SoundBlaster AWE64PNP
    /// </summary>
...
begin
  ...
  Self.SoundDeviceProperties.FCaption := EmptyStr;
  Self.SoundDeviceProperties.FConfigManagerErrorCode := 0;
  Self.SoundDeviceProperties.FConfigManagerUserConfig := False;
  Self.SoundDeviceProperties.FCreationClassName := EmptyStr;
  Self.SoundDeviceProperties.FDescription := EmptyStr;
  Self.SoundDeviceProperties.FDeviceID := EmptyStr;
  Self.SoundDeviceProperties.FDMABufferSize := 0;
  Self.SoundDeviceProperties.FErrorCleared := False;
  Self.SoundDeviceProperties.FErrorDescription := EmptyStr;
  Self.SoundDeviceProperties.FInstallDate := 0;
  Self.SoundDeviceProperties.FLastErrorCode := 0;
  Self.SoundDeviceProperties.FManufacturer := EmptyStr;
  Self.SoundDeviceProperties.FMPU401Address := 0;
  Self.SoundDeviceProperties.FName := EmptyStr;
  Self.SoundDeviceProperties.FPNPDeviceID := EmptyStr;
  Self.SoundDeviceProperties.FPowerManagementCapabilitiesCount := 0;
  Self.SoundDeviceProperties.FPowerManagementCapabilitiesAsString := EmptyStr;
  SetLength(SoundDeviceProperties.FPowerManagementCapabilities, 0);
  Self.SoundDeviceProperties.FPowerManagementSupported := False;
  Self.SoundDeviceProperties.FProductName := EmptyStr;
  Self.SoundDeviceProperties.FStatus := EmptyStr;
  Self.SoundDeviceProperties.FStatusInfo := 0;
  Self.SoundDeviceProperties.FSystemCreationClassName := EmptyStr;
  Self.SoundDeviceProperties.FSystemName := EmptyStr;
end;
...
begin
  ...
  Self.MSDNHelp := 'https://docs.microsoft.com/en-us/windows/win32/cimwin32prov/win32-sounddevice';
end;
...
function TSoundDeviceProperties.GetAllAvailabilityAsString(index:integer):string;
begin
  case index of
...
// Obtener la propiedad como string
function TSoundDeviceProperties.GetAllConfigManagerErrorCodeAsString(index:integer):string;
begin
  case index of
...
// Obtener la propiedad como string
function TSoundDeviceProperties.GetAllPowerManagementCapabilitiesAsString(index:integer):string;
begin
  case index of
...
// Obtener la propiedad como string
function TSoundDeviceProperties.GetAllStatusInfoAsString(index:integer):string;
begin
  case index of
...
function TSoundDeviceProperties.GetAllAvailabilityCount:integer;
begin
  Result := 21
end;

// Obtener núm. de elementos de la propiedad como string
function TSoundDeviceProperties.GetAllConfigManagerErrorCodeCount:integer;
begin
  Result := 32
end;

// Obtener núm. de elementos de la propiedad como string
function TSoundDeviceProperties.GetAllPowerManagementCapabilitiesCount:integer;
begin
  Result := 8
end;

// Obtener núm. de elementos de la propiedad como string
function TSoundDeviceProperties.GetAllStatusInfoCount:integer;
begin
  Result := 5
end;
