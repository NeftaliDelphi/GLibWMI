...
type
  ...
  public
    ...
    // Obtener el número de elementos disponibles de la propiedad <DisplayType>
  ...
  published
    ...
    /// <summary>
    ///  La propiedad DeviceID contiene una cadena que identifica de forma única un monitor de escritorio.
    ///  Ejemplo: 
    ///  MonitorEscritorio1
    /// </summary>
    property DeviceID:string read FDeviceID write FDeviceID stored False;
    /// <summary>
    ///  El tipo de monitor de escritorio o CRT. Por ejemplo, monitores multiscan color o monocromático (valores 
    ...
    /// <summary>
    ///  La propiedad PixelsPerXLogicalInch indica la resolución en el eje X (dirección horizontal) del monit
    ///  or.
    /// </summary>
    property PixelsPerXLogicalInch:integer read FPixelsPerXLogicalInch write FPixelsPerXLogicalInch stored False;
    /// <summary>
    ///  La propiedad PixelsPerYLogicalInch indica la resolución en el eje Y (dirección vertical) del monitor
    ///  .
    /// </summary>
...
const 
  ...
  ENUM_STRING_DISPLAYTYPE_03 = 'Monocromático Multiscan';
  ENUM_STRING_DISPLAYTYPE_04 = 'Color de frecuencia fija';
  ENUM_STRING_DISPLAYTYPE_05 = 'Monocromático de frecuencia fija';
