...
// File generated on 16/06/2020 16:20:59 from Type Library described below.
...
begin
  DefaultInterface.YearSpecified := bYearSpecified;
end;
...
begin
  DefaultInterface.MonthSpecified := bMonthSpecified;
end;
...
begin
  DefaultInterface.DaySpecified := bDaySpecified;
end;
...
begin
  DefaultInterface.HoursSpecified := bHoursSpecified;
end;
...
begin
  DefaultInterface.Minutes := iMinutes;
end;
...
begin
  DefaultInterface.MinutesSpecified := bMinutesSpecified;
end;
...
begin
  DefaultInterface.Seconds := iSeconds;
end;
...
begin
  DefaultInterface.SecondsSpecified := bSecondsSpecified;
end;
...
begin
  DefaultInterface.Microseconds := iMicroseconds;
end;
...
begin
  DefaultInterface.MicrosecondsSpecified := bMicrosecondsSpecified;
end;
...
begin
  DefaultInterface.UTCSpecified := bUTCSpecified;
end;
...
begin
  DefaultInterface.IsInterval := bIsInterval;
end;
...
begin
  DefaultInterface.AutoReconnect := bCount;
end;
