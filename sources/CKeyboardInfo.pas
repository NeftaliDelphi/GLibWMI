{
TKeyboardInfo  Component Version 1.1 - Suite GLib 
Copyright (©) 2009,  by Germán Estévez (Neftalí) 
 
  Representa el teclado instalado en la máquina.
...
type 
  ...
  public
    ...
    function GetPasswordAsString():string;
  ...
  published
    ...
    property PasswordAsString:string read GetPasswordAsString  write FPasswordAsString stored False;
  ...
  //: Implementación para el acceso vía WMI a la clase Win32_Keyboard
...
const
  ENUM_STRING_PASSWORD_1 = 'Other';
  ENUM_STRING_PASSWORD_2 = 'Unknown';
  ENUM_STRING_PASSWORD_3 = 'Disabled';
  ENUM_STRING_PASSWORD_4 = 'Enabled';
  ENUM_STRING_PASSWORD_5 = 'Not Implemented';
...
begin
  ...
  Self.KeyboardProperties.FCaption := STR_EMPTY;
  Self.KeyboardProperties.FConfigManagerErrorCode := 0;
  Self.KeyboardProperties.FConfigManagerUserConfig := False;
  Self.KeyboardProperties.FCreationClassName := STR_EMPTY;
  Self.KeyboardProperties.FDescription := STR_EMPTY;
  Self.KeyboardProperties.FDeviceID := STR_EMPTY;
  Self.KeyboardProperties.FErrorCleared := False;
  Self.KeyboardProperties.FErrorDescription := STR_EMPTY;
  Self.KeyboardProperties.FInstallDate := 0;
  Self.KeyboardProperties.FIsLocked := False;
  Self.KeyboardProperties.FLastErrorCode := 0;
  Self.KeyboardProperties.FLayout := STR_EMPTY;
  Self.KeyboardProperties.FName := STR_EMPTY;
  Self.KeyboardProperties.FNumberOfFunctionKeys := 0;
  Self.KeyboardProperties.FPassword := 0;
  Self.KeyboardProperties.FPNPDeviceID := STR_EMPTY;
  Self.KeyboardProperties.FPowerManagementCapabilitiesCount := 0;
  Self.KeyboardProperties.FPowerManagementCapabilitiesAsString := STR_EMPTY;
  SetLength(Self.KeyboardProperties.FPowerManagementCapabilities,0);
  Self.KeyboardProperties.FPowerManagementSupported := False;
  Self.KeyboardProperties.FStatus := STR_EMPTY;
  Self.KeyboardProperties.FStatusInfo := 0;
  Self.KeyboardProperties.FSystemCreationClassName := STR_EMPTY;
  Self.KeyboardProperties.FSystemName := STR_EMPTY;
...
begin 
  ...
  Self.MSDNHelp := 'http://msdn.microsoft.com/en-us/library/aa394166(VS.85).aspx';
end; 
...
function TKeyboardProperties.GetAvailabilityAsString():string;
begin
...
// Obtener la propiedad como string
function TKeyboardProperties.GetConfigManagerErrorCodeAsString():string;
begin
...
// Obtener la propiedad como string
function TKeyboardProperties.GetPasswordAsString():string;
begin
  case FPassword of
    1: Result := ENUM_STRING_PASSWORD_1;
    2: Result := ENUM_STRING_PASSWORD_2;
    3: Result := ENUM_STRING_PASSWORD_3;
    4: Result := ENUM_STRING_PASSWORD_4;
    5: Result := ENUM_STRING_PASSWORD_5;
  else
    Result := STR_EMPTY;
  end;
end;
...
// Obtener la propiedad como string
function TKeyboardProperties.GetStatusInfoAsString():string;
begin
  case FStatusInfo of
